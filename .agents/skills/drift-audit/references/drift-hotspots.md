...
- `newsletters/Dockerfile` versus the current build output
- `frontend/services/api.ts` versus `frontend/pages/ai_chat.tsx`
- `agentic_ai/README.md` and `Makefile` versus `mcp_server/app.py`
- `shell/` scripts versus the root-script workflow
- infrastructure docs versus Terraform and Kubernetes manifests
