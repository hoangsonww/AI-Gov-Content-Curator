...
# --------------------------------------------------
# Adds a cron entry to run `daily.sh` at 12:00 PM daily.
...
# You should see a line like this: 0 12 * * * /home/you/scripts/daily.sh >> /home/you/scripts/daily.log 2>&1
...
#          │ │ │ │ ┌ day-of-week (*)
#          │ │ │ │ │
CRON_JOB="0 15 * * * $DAILY_SH >> $LOGFILE 2>&1"
