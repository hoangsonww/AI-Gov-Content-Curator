...
import { AgentDefinition, ModelProvider, ChatIntentType } from "./types";

import { SUPERVISOR_SYSTEM_PROMPT } from "./prompts/system/supervisor";
  ...
  static createWithDefaults(): AgentRegistry {
    ...
    const defaults: AgentDefinition[] = [
      ...
      },
      {
        ...
        description:
          "Identifies trends and patterns in government policy coverage",
        provider: ModelProvider.anthropic,
        model: "claude-sonnet-4-6",
